"""
Django settings for cia_api project.
...
SECRET_KEY = 'django-insecure-_y5n*-wooddn8mmg55v8x%1olf+==tv4+y6k&*5)=((ejtn%by'
...
ROOT_URLCONF = 'djangostack_api.urls'
...
WSGI_APPLICATION = 'djangostack_api.wsgi.application'
